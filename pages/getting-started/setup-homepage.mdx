...
Here you will learn how to setup the homepage from the Demos. Please note that **Elementor** and **Selleradise Widgets** must be installed before proceeding. Also make sure that you have imported the [demo content](/getting-started/import-demo-content).
